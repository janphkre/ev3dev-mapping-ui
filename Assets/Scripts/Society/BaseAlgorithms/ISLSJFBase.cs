...
class ISLSJFBase {
    ...
    public void computeInfoAddition(RobotPose previousPose, List<Feature> features, ICovarianceMatrix inversedCovariance, SparseCovarianceMatrix infoMatrix, SparseColumn infoVector, List<IFeature> globalStateVector) {
        SparseMatrix jacobianH = ComputeJacobianH(previousPose, features);
        //SparseColumn noiseW = computeNoiseW(localMapFeatures);

        SparseMatrix infoMatrixAddition = null;//TODO!: ~jacobianH * inversedCovariance;
